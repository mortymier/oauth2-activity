...
@Service
public class CustomOAuth2Service2 extends DefaultOAuth2UserService
{
    @Autowired
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException
    {
        ...
        // Check if user already exists in the database. If not, create a record of it.
        ...
        // Check if provider already exists in the database. If not, create a record of it.
